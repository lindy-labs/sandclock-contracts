...
contract scWETH is sc4626, IFlashLoanRecipient {
    ...
    // // Principal deposited per user
    // mapping(address => uint256) public totalPrincipal;

    // total Profit generated by vault
    ...
    function takeTreasuryFees() public {
        // store the old total
        uint256 oldTotalInvested = totalInvested;
        uint256 newTotalInvested = totalAssets();

        console.log("oldTotalInvested", oldTotalInvested);
        console.log("newTotalInvested", newTotalInvested);

        if (newTotalInvested > oldTotalInvested) {
            // profit since last harvest, zero if there was a loss
            uint256 profit = newTotalInvested - oldTotalInvested;
    ...
    function redeem(uint256 shares, address receiver, address owner) public override returns (uint256 assets) {
        ...
        totalInvested = totalInvested > assets ? totalInvested - assets : 0;
