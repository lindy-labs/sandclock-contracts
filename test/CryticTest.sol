...
contract CryticERC4626_scUSDC is CryticERC4626PropertyTests {
    ...
    constructor() {
        ...
        scUSDC scUsdc = new scUSDC(scUsdcParams);
        initialize(address(scUsdc), address(scUsdc.asset()), false);
    }
}

contract CryticERC4626_scWETH is CryticERC4626PropertyTests {
    address constant HEVM_ADDRESS = 0x7109709ECfa91a80626fF3989D68f67F5b1DD12D;
    Hevm hevm = Hevm(HEVM_ADDRESS);
    address _admin = address(this);
    address _keeper = address(0x05);
