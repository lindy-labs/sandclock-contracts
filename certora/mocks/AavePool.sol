...
import {IERC20WithPermit} from 'lib/aave-v3-core/contracts/interfaces/IERC20WithPermit.sol';
import "./VariableDebtToken.sol";

contract AavePool is IPool {
  ...
  function borrow(
    ...
    variableDebtToken.mint(msg.sender, onBehalfOf, amount, 1e27);
  ...
  function repay(
    ...
    variableDebtToken.burn(onBehalfOf, amount, 1e27);
    IERC20(asset).transferFrom(msg.sender, address(aToken), amount);
