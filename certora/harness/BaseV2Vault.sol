...
import {TokenOutNotAllowed} from "src/errors/scErrors.sol";

import {ERC20} from "lib/solmate/src/tokens/ERC20.sol";
import {Address} from "lib/openzeppelin-contracts/contracts/utils/Address.sol";
import {EnumerableMap} from "openzeppelin-contracts/utils/structs/EnumerableMap.sol";

import {ProtocolNotSupported, ProtocolInUse, ZeroAddress} from "src/errors/scErrors.sol";
...
abstract contract BaseV2Vault is sc4626, IFlashLoanRecipient {
    ...
    IVault public balancerVault;// = IVault(C.BALANCER_VAULT);
    ...
    function getAdapter(uint256 _adapterId) public view returns (address adapter) {
