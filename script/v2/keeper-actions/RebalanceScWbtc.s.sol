 ...
 */
contract RebalanceScWbtc is scCrossAssetYieldVaultRebalanceScript {
    /*//////////////////////////////////////////////////////////////
                          SCRIPT PARAMETERS
    //////////////////////////////////////////////////////////////*/
    ...
    // minProfitToReinvest - the minimum amount of WETH profit (converted to WBTC) that needs to be made for reinvesting to make sense (ie gas costs < profit made)
    // maxProfitSellSlippage (scCrossAssetYieldVaultRebalanceScript) - the maximum amount of slippage allowed when selling WETH profit for WBTC
    ...
    function _getMinProfitToReinvest() internal pure override returns (uint256) {
        return 0.005e8; // 0.005 WBTC ~= 250 USD if we assume 1 BTC = 50k USD
    }

    function _getVaultAddress() internal virtual override returns (scCrossAssetYieldVault) {
        return scCrossAssetYieldVault(vm.envOr("SC_WBTC", MainnetAddresses.SCWBTC));
    }
    ...
    function _initializeAdapterSettings() internal override {
        adapterSettings.push(
            AdapterSettings({
                adapterId: 1, // TODO: IAdapter(MainnetAddresses.SCWBTC_AAVEV3_ADAPTER).id(),
