...
/**
 * A script for executing "exitAllPositions" function on the scWBTC vaults.
 * This results in withdrawing all WETH invested into leveraged staking (scWETH vault), repaying all WETH debt (using a flashloan if necessary) and withdrawing all WBTC collateral to the vault.
 */
contract ExitAllPositionsScWbtc is scCrossAssetYieldVaultExitAllPositionsScript {
    /*//////////////////////////////////////////////////////////////
                          SCRIPT PARAMETERS
    //////////////////////////////////////////////////////////////*/
    ...
    function _getVaultAddress() internal virtual override returns (scCrossAssetYieldVault) {
        return scCrossAssetYieldVault(vm.envOr("SC_WBTC_V2", MainnetAddresses.SCWBTC));
    }
